...
class TestFilesystem:
    ...
    def test_valid_path_returns_200(self, client, auth, mocker_shell):
    ...
    def test_permission_denied_returns_403(self, client, auth, mocker_shell):
    ...
    def test_missing_resource_returns_404(self, client, auth, mocker_shell):
